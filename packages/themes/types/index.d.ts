 ...
 *
 */
export interface ThemeOptions { prefix?: string; darkModeSelector?: string; cssLayer?: boolean | { name?: string; order?: string }; }
export interface StyleOptions { dt: (key: string, fallback?: string | number | Pick<StyleOptions, 'dt'>) => string | number | undefined; }
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@phasevueui/styled-core` instead.
