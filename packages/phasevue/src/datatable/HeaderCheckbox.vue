...
export default {
    ...
    computed: {
        headerCheckboxAriaLabel() {
            return this.$phasevue.config.locale.aria ? (this.checked ? this.$phasevue.config.locale.aria.selectAll : this.$phasevue.config.locale.aria.unselectAll) : undefined;
        }
    },
    components: {
        CheckIcon,
