...
import PencilIcon from '@phasevueui/icons/pencil';
...
export default {
    ...
    computed: {
        ...
        expandButtonAriaLabel() {
            return this.$phasevue.config.locale.aria ? (this.isRowExpanded ? this.$phasevue.config.locale.aria.expandRow : this.$phasevue.config.locale.aria.collapseRow) : undefined;
        },
        initButtonAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.editRow : undefined;
        },
        saveButtonAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.saveEdit : undefined;
        },
        cancelButtonAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.cancelEdit : undefined;
        }
    },
    components: {
