 ...
 *
 * [Live Demo](https://www.phasevue.org/datatable/)
 *
 * @module datatable
 *
 */
import type { DefineComponent, DesignToken, EmitFn, HintedString, NoInfer, Nullable, PassThrough } from '@phasevueui/core';
import type { ComponentHooks } from '@phasevueui/core/basecomponent';
import type { ButtonProps } from 'phasevue/button';
import type { ColumnPassThroughOptionType } from 'phasevue/column';
import type { ColumnGroupPassThroughOptionType } from 'phasevue/columngroup';
import type { PaginatorPassThroughOptionType } from 'phasevue/paginator';
import type { PassThroughOptions } from 'phasevue/passthrough';
import type { RowPassThroughOptionType } from 'phasevue/row';
import type { VirtualScrollerPassThroughOptionType, VirtualScrollerProps } from 'phasevue/virtualscroller';
