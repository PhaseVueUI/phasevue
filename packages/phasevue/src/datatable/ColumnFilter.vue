...
import FilterIcon from '@phasevueui/icons/filter';
import FilterFillIcon from '@phasevueui/icons/filterfill';
import FilterSlashIcon from '@phasevueui/icons/filterslash';
import PlusIcon from '@phasevueui/icons/plus';
import TrashIcon from '@phasevueui/icons/trash';
...
export default {
    ...
    methods: {
        ...
        onOverlayEnter(el) {
            ...
            ZIndex.set('overlay', el, this.$phasevue.config.zIndex.overlay);
    ...
    computed: {
        ...
        matchModes() {
            return (
                ...
                this.$phasevue.config.filterMatchModeOptions[this.type].map((key) => {
                    return { label: this.$phasevue.config.locale[key], value: key };
                })
            );
        },
        isShowMatchModes() {
        ...
        operatorOptions() {
            return [
                { label: this.$phasevue.config.locale.matchAll, value: FilterOperator.AND },
                { label: this.$phasevue.config.locale.matchAny, value: FilterOperator.OR }
            ];
        },
        noFilterLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.noFilter : undefined;
        },
        isShowOperator() {
        ...
        removeRuleButtonLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.removeRule : undefined;
        },
        addRuleButtonLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.addRule : undefined;
        },
        isShowAddConstraint() {
            return this.showAddButton && this.filters[this.field].operator && this.fieldConstraints && this.fieldConstraints.length < this.maxConstraints;
        },
        clearButtonLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.clear : undefined;
        },
        applyButtonLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.apply : undefined;
        },
        columnFilterButtonAriaLabel() {
            return this.$phasevue.config.locale?.aria ? (this.overlayVisible ? this.$phasevue.config.locale.aria.hideFilterMenu : this.$phasevue.config.locale.aria.showFilterMenu) : undefined;
        },
        filterOperatorAriaLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.filterOperator : undefined;
        },
        filterRuleAriaLabel() {
            return this.$phasevue.config.locale ? this.$phasevue.config.locale.filterConstraint : undefined;
        },
