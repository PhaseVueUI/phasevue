...
export default {
    ...
    computed: {
        checkboxAriaLabel() {
            return this.$phasevue.config.locale.aria ? (this.checked ? this.$phasevue.config.locale.aria.selectRow : this.$phasevue.config.locale.aria.unselectRow) : undefined;
        }
    },
    components: {
        CheckIcon,
