 ...
 *
 * [Live Demo](https://www.phasevue.org/password/)
 *
 * @module password
 *
 */
...
export interface PasswordProps extends Omit<InputHTMLAttributes, 'size'> {
    ...
    /**
     * Text to prompt password entry. Defaults to PhaseVue Locale configuration.
     */
    ...
    /**
     * Text for a weak password. Defaults to PhaseVue Locale configuration.
     */
    weakLabel?: string | undefined;
    /**
     * Text for a medium password. Defaults to PhaseVue Locale configuration.
     */
    mediumLabel?: string | undefined;
    /**
     * Text for a strong password. Defaults to PhaseVue Locale configuration.
     */
