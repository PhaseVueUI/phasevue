...
export default {
    ...
    computed: {
        ...
        weakText() {
            return this.weakLabel || this.$phasevue.config.locale.weak;
        },
        mediumText() {
            return this.mediumLabel || this.$phasevue.config.locale.medium;
        },
        strongText() {
            return this.strongLabel || this.$phasevue.config.locale.strong;
        },
        promptText() {
            return this.promptLabel || this.$phasevue.config.locale.passwordPrompt;
        },
        isClearIconVisible() {
