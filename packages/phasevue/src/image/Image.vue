...
import SearchPlusIcon from '@phasevueui/icons/searchplus';
import TimesIcon from '@phasevueui/icons/times';
import UndoIcon from '@phasevueui/icons/undo';
...
export default {
    ...
    methods: {
        ...
        onBeforeEnter() {
            ZIndex.set('modal', this.mask, this.$phasevue.config.zIndex.modal);
        },
        onEnter() {
            this.focus();
            this.$emit('show');
    ...
    computed: {
        ...
        rightAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.rotateRight : undefined;
        },
        leftAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.rotateLeft : undefined;
        },
        zoomInAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.zoomIn : undefined;
        },
        zoomOutAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.zoomOut : undefined;
        },
        zoomImageAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.zoomImage : undefined;
        },
        closeAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.close : undefined;
        }
    },
    components: {
        Portal: Portal,
