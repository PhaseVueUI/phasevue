    ...
    methods: {
        ...
        createStyle() {
            if (!this.carouselStyle) {
                ...
                setAttribute(this.carouselStyle, 'nonce', this.$phasevue?.config?.csp?.nonce);
        ...
        ariaSlideNumber(value) {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.slideNumber.replace(/{slideNumber}/g, value) : undefined;
        },
        ariaPageLabel(value) {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.pageLabel.replace(/{page}/g, value) : undefined;
        }
    },
    computed: {
        totalIndicators() {
        ...
        ariaSlideLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.slide : undefined;
        },
        ariaPrevButtonLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.prevPageLabel : undefined;
        },
        ariaNextButtonLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.nextPageLabel : undefined;
        },
        empty() {
            return !this.value || this.value.length === 0;
        },
        emptyMessageText() {
            return this.$phasevue.config?.locale?.emptyMessage || '';
        }
    },
    components: {
        Button,
