...
import type { CheckboxPassThroughOptionType } from 'phasevue/checkbox';
import type { DataTablePassThroughOptions } from 'phasevue/datatable';
import type { PassThroughOptions } from 'phasevue/passthrough';
import type { RadioButtonPassThroughOptionType } from 'phasevue/radiobutton';
import type { SelectPassThroughOptionType } from 'phasevue/select';
import type { VirtualScrollerLoaderOptions } from 'phasevue/virtualscroller';
...
export interface ColumnProps {
    ...
    /**
     * Type of data. It's value is related to PhaseVue.filterMatchModeOptions config.
     */
