...
import { equals, findLastIndex, isEmpty, isNotEmpty, isPrintableCharacter, isString, resolveFieldData } from '@phasevueui/utils/object';
...
export default {
    ...
    computed: {
        ...
        searchMessageText() {
            return this.searchMessage || this.$phasevue.config.locale.searchMessage || '';
        },
        emptySearchMessageText() {
            return this.emptySearchMessage || this.$phasevue.config.locale.emptySearchMessage || '';
        },
        emptyMessageText() {
