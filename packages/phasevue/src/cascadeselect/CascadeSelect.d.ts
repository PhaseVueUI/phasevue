 ...
 *
 * [Live Demo](https://www.phasevue.org/cascadeselect/)
 *
...
export interface CascadeSelectProps {
    ...
    /**
     * Text to be displayed when there are no options available. Defaults to value from PhaseVue locale configuration.
