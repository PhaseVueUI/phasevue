import DynamicDialogEventBus from 'phasevue/dynamicdialogeventbus';
import { PhaseVueDialogSymbol } from 'phasevue/usedialog';
...
export default {
    install: (app) => {
        ...
        app.provide(PhaseVueDialogSymbol, DialogService);
    }
};
