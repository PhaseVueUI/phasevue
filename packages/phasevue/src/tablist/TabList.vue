...
export default {
    ...
    computed: {
        ...
        prevButtonAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.previous : undefined;
        },
        nextButtonAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.next : undefined;
        },
        dataP() {
            return cn({
