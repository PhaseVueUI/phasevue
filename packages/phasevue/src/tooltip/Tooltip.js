import { addClass, createElement, fadeIn, findSingle, getAttribute, getOuterHeight, getOuterWidth, getViewport, getWindowScrollLeft, getWindowScrollTop, hasClass, isExist, isTouchDevice, removeClass } from '@phasevueui/utils/dom';
...
const Tooltip = BaseTooltip.extend('tooltip', {
    beforeMount(el, options) {
        ...
        target.$_ptooltipZIndex = options.instance.$phasevue?.config?.zIndex?.tooltip;
