import { style } from '@phasevueui/styles-core/inputchips';
...
const classes = {
    ...
    input: ({ props, instance }) => [
        'p-inputchips-input',
        {
            'p-variant-filled': props.variant ? props.variant === 'filled' : instance.$phasevue.config.inputStyle === 'filled' || instance.$phasevue.config.inputVariant === 'filled'
        }
    ],
