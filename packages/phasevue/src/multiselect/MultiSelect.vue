...
import { absolutePosition, addStyle, findSingle, focus, getFirstFocusableElement, getFocusableElements, getLastFocusableElement, getOuterWidth, isTouchDevice, relativePosition } from '@phasevueui/utils/dom';
import { equals, findLastIndex, isEmpty, isNotEmpty, isPrintableCharacter, resolveFieldData } from '@phasevueui/utils/object';
...
import Checkbox from 'phasevue/checkbox';
import Chip from 'phasevue/chip';
import IconField from 'phasevue/iconfield';
import InputIcon from 'phasevue/inputicon';
...
import VirtualScroller from 'phasevue/virtualscroller';
...
export default {
    ...
    methods: {
        ...
        getSelectedItemsLabel() {
            let pattern = /{(.*?)}/;
            const selectedItemsLabel = this.selectedItemsLabel || this.$phasevue.config.locale.selectionMessage;
    ...
    computed: {
        ...
        filterMessageText() {
            return this.filterMessage || this.$phasevue.config.locale.searchMessage || '';
        },
        emptyFilterMessageText() {
            return this.emptyFilterMessage || this.$phasevue.config.locale.emptySearchMessage || this.$phasevue.config.locale.emptyFilterMessage || '';
        },
        emptyMessageText() {
            return this.emptyMessage || this.$phasevue.config.locale.emptyMessage || '';
        },
        selectionMessageText() {
            return this.selectionMessage || this.$phasevue.config.locale.selectionMessage || '';
        },
        emptySelectionMessageText() {
            return this.emptySelectionMessage || this.$phasevue.config.locale.emptySelectionMessage || '';
        },
        selectedMessageText() {
        ...
        toggleAllAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria[this.allSelected ? 'selectAll' : 'unselectAll'] : undefined;
        },
        listAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.listLabel : undefined;
        },
