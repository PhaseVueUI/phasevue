 ...
 *
 * [Live Demo](https://www.phasevue.org/fileupload/)
 *
 * @module fileupload
 *
 */
...
export interface FileUploadProps {
    ...
    /**
     * Label of the choose button. Defaults to PhaseVue Locale configuration.
     */
    chooseLabel?: string | undefined;
    /**
     * Label of the upload button. Defaults to PhaseVue Locale configuration.
     */
    uploadLabel?: string | undefined;
    /**
     * Label of the cancel button. Defaults to PhaseVue Locale configuration.
     * @defaultValue Cancel
     */
    cancelLabel?: string | undefined;
    /**
     * Whether to use the default upload or a manual implementation defined in uploadHandler callback. Defaults to PhaseVue Locale configuration.
     */
