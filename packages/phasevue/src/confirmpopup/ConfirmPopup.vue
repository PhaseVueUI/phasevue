    ...
    computed: {
        ...
        acceptLabel() {
            if (this.confirmation) {
                ...
                return confirmation.acceptLabel || confirmation.acceptProps?.label || this.$phasevue.config.locale.accept;
            }

            return this.$phasevue.config.locale.accept;
        },
        rejectLabel() {
            if (this.confirmation) {
                const confirmation = this.confirmation;

                return confirmation.rejectLabel || confirmation.rejectProps?.label || this.$phasevue.config.locale.reject;
            }

            return this.$phasevue.config.locale.reject;
        },
        acceptIcon() {
