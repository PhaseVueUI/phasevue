...
import AngleDoubleUpIcon from '@phasevueui/icons/angledoubleup';
import AngleDownIcon from '@phasevueui/icons/angledown';
import AngleLeftIcon from '@phasevueui/icons/angleleft';
    ...
    methods: {
        ...
        createStyle() {
            if (!this.styleElement && !this.isUnstyled) {
                ...
                setAttribute(this.styleElement, 'nonce', this.$phasevue?.config?.csp?.nonce);
...
`;
    ...
    computed: {
        ...
        moveUpAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveUp : undefined;
        },
        moveTopAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveTop : undefined;
        },
        moveDownAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveDown : undefined;
        },
        moveBottomAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveBottom : undefined;
        },
        moveToTargetAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveToTarget : undefined;
        },
        moveAllToTargetAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveAllToTarget : undefined;
        },
        moveToSourceAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveToSource : undefined;
        },
        moveAllToSourceAriaLabel() {
            return this.$phasevue.config.locale.aria ? this.$phasevue.config.locale.aria.moveAllToSource : undefined;
        }
    },
    components: {
        Listbox,
