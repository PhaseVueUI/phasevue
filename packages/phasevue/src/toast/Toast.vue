...
export default {
    ...
    methods: {
        ...
        onEnter() {
            if (this.autoZIndex) {
                ZIndex.set('modal', this.$refs.container, this.baseZIndex || this.$phasevue.config.zIndex.modal);
            }
        },
        onLeave() {
