...
let modules = {
    ...
    umd: [
        `/***************** PhaseVue (Auto-Generated) *****************/

// API
export * from '@phasevueui/core';

// BaseIcon
export { default as BaseIcon } from '@phasevueui/icons/baseicon';
...
// Utils
export * from 'phasevue/utils';

// UseConfirm
export * from 'phasevue/useconfirm';

// UseDialog
export * from 'phasevue/usedialog';

// UseToast
export * from 'phasevue/usetoast';

// UseStyle
export * from 'phasevue/usestyle';
`
    ]
};
...
`
                    ...
                    modules.esm.push(
                        `
// ${fileName}
export * from 'phasevue/${folderName}';
export { default as ${fileName} } from 'phasevue/${folderName}';
`
                    );
                }
...
`
                                ...
                                modules.esm.push(
                                    `export * from 'phasevue/${folderName}/style';
export { default as ${subFileName} } from 'phasevue/${folderName}/style';
`
                                );
                            }
                        }
...
// UMD
fs.writeFileSync(INPUT_DIR + 'umd/phasevue.js', modules.umd.join(''));
