const PasswordProps = [
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Text to prompt password entry. Defaults to PhaseVue Locale configuration.'
    },
    {
        name: 'mediumRegex',
        type: 'string',
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Text for a weak password. Defaults to PhaseVue Locale configuration.'
    },
    {
        name: 'mediumLabel',
        type: 'string',
        default: 'null',
        description: 'Text for a medium password. Defaults to PhaseVue Locale configuration.'
    },
    {
        name: 'strongLabel',
        type: 'string',
        default: 'null',
        description: 'Text for a strong password. Defaults to PhaseVue Locale configuration.'
    },
    {
        name: 'feedback',
        type: 'boolean',
