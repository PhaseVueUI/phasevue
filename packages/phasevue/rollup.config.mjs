...
const INLINE_EXTERNALS = [/@phasevueui\/core\/.*/, /@phasevueui\/icons\/.*/, '@phasevueui/styled-core', /@phasevueui\/utils\/.*/];
...
const ALIAS_ENTRIES = [
    ...
    // @todo - Remove
    { find: '@phasevueui/core/api', replacement: path.resolve(__dirname, '../core/src/api/Api.js') },
    { find: '@phasevueui/core/base/style', replacement: path.resolve(__dirname, '../core/src/base/style/BaseStyle.js') },
    { find: '@phasevueui/core/base', replacement: path.resolve(__dirname, '../core/src/base/Base.js') },
    { find: '@phasevueui/core/basecomponent/style', replacement: path.resolve(__dirname, '../core/src/basecomponent/style/BaseComponentStyle.js') },
    { find: '@phasevueui/core/basecomponent', replacement: path.resolve(__dirname, '../core/src/basecomponent/BaseComponent.vue') },
    { find: '@phasevueui/core/basedirective', replacement: path.resolve(__dirname, '../core/src/basedirective/BaseDirective.js') },
    { find: '@phasevueui/core/baseeditableholder', replacement: path.resolve(__dirname, '../core/src/baseeditableholder/BaseEditableHolder.vue') },
    { find: '@phasevueui/core/baseinput', replacement: path.resolve(__dirname, '../core/src/baseinput/BaseInput.vue') },
    { find: '@phasevueui/core/config', replacement: path.resolve(__dirname, '../core/src/config/PhaseVue.js') },
    { find: '@phasevueui/core/service', replacement: path.resolve(__dirname, '../core/src/service/PhaseVueService.js') },
    { find: '@phasevueui/core/useattrselector', replacement: path.resolve(__dirname, '../core/src/useattrselector/UseAttrSelector.js') },
    { find: '@phasevueui/core/useid', replacement: path.resolve(__dirname, '../core/src/useid/UseId.js') },
    { find: '@phasevueui/core/usestyle', replacement: path.resolve(__dirname, '../core/src/usestyle/UseStyle.js') },
    { find: '@phasevueui/core/utils', replacement: path.resolve(__dirname, '../core/src/utils/Utils.js') },
    { find: '@phasevueui/core', replacement: path.resolve(__dirname, '../core/src/index.js') },
    { find: '@phasevueui/icons/baseicon/style', replacement: path.resolve(__dirname, '../icons/src/baseicon/style/BaseIconStyle.js') },
    { find: '@phasevueui/icons/baseicon', replacement: path.resolve(__dirname, '../icons/src/baseicon/BaseIcon.vue') }
];
...
function addLibrary() {
    ...
    ENTRY.format.umd({ name: 'PhaseVue', input: process.env.INPUT_DIR + 'umd/phasevue.js', output: process.env.OUTPUT_DIR + 'umd/phasevue', minify: true });
}
