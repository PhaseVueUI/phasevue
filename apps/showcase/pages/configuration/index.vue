<template>
    <Head>
        <Title>Configuration - PhaseVue</Title>
        <Meta name="description" content="Application wide configuration for PhaseVue." />
    </Head>
    <div class="doc">
        <div class="doc-main">
            <div class="doc-intro">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                    <div class="flex-1">
                        <h1>Configuration</h1>
                        <p>Application wide configuration for PhaseVue.</p>
                    </div>
