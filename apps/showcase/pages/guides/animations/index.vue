<template>
    <div>
        <Head>
            <Title>Animations - PhaseVue</Title>
            <Meta name="description" content="PhaseVue animations guide." />
        </Head>
                ...
                <div class="doc-intro">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                        <div class="flex-1">
                            <h1>Animations</h1>
                            <p>
                                Various PhaseVue Components utilize native CSS animations to provide an enhanced user experience. The default animations are based on the best practices recommended by the usability experts. In case you need to
