<template>
    <div>
        <Head>
            <Title>Accessibility - PhaseVue</Title>
            ...
            <div class="doc-main">
                <div class="doc-intro">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                        <div class="flex-1">
                            <h1>Accessibility</h1>
                            <p>PhaseVue has WCAG 2.1 AA level compliance, refer to the accessibility documentation of each component for detailed information.</p>
                        </div>
