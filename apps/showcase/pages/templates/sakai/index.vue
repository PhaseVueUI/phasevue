                ...
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                liveHref: 'https://sakai.phasevue.org/',
                                docHref: 'https://sakai.phasevue.org/documentation',
                                free: true,
                                storeHref: 'https://github.com/PhaseVueUI/sakai-vue',
                                supportHref: 'https://github.com/PhaseVueUI/sakai-vue/issues',
                                pattern: {
                                    ...
                                    src: '/images/templates/sakai/sakai-hero-pattern.png'
                                }
                            }
                        }
                    },
                        ...
                        props: {
                            featuresData: [
                                ...
                                },
                                {
                                    ...
                                    src: '/images/templates/sakai/features-animation-blocks.png'
                                },
                                {
                                    id: 3,
                                    title: 'PrimeIcons',
                                    ...
                                    src: '/images/templates/sakai/features-animation-icons.png'
                                }
                            ]
                        },
                        slots: {
                        ...
                        props: {
                            featuresData: [
                                ...
                                },
                                {
                                    ...
                                    src: '/images/templates/sakai/sakai-features2-compatible.png',
                                    darkSrc: '/images/templates/sakai/sakai-features2-compatible-dark.png'
                                },
                                {
                                    ...
                                    src: '/images/templates/sakai/sakai-features2-customizable.png',
                                    darkSrc: '/images/templates/sakai/sakai-features2-customizable-dark.png'
                                },
                                {
