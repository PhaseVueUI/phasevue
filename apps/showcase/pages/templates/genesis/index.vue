                ...
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                liveHref: 'https://genesis.phasevue.org',
                                ...
                                pattern: {
                                    ...
                                    src: '/images/templates/genesis/hero-pattern.png'
                                },
                                isMultipurpose: true
                            }
                        }
                    ...
                    },
                    {
                        ...
                        slots: {
                            ...
                            description4: `
                                ...
                                <a href="https://www.figma.com/design/bGujrJyznnSatJFMtkXbTN/Preview-%7C-Genesis?node-id=0-1&t=etuXAwkUAEuhJ3p0-1" target="_blank" rel="noopener noreferrer">preview the Figma file</a> before the purchase. Note that PhaseVue UI components are
                                excluded from the Genesis Figma file as they are available in <PhaseVueNuxtLink to="/uikit">PrimeOne for Figma</PhaseVueNuxtLink> only.`
                        }
                    },
                    {
                        name: markRaw(TemplateFeatures),
