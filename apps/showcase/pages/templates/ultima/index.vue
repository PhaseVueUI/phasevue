    ...
    data() {
        return {
            ultimaData: {
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                liveHref: 'https://ultima.phasevue.org',
                                docHref: 'https://ultima.phasevue.org/documentation',
                                ...
                                pattern: {
                                    ...
                                    src: '/images/templates/ultima/ultima-hero-pattern.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://ultima.phasevue.org/documentation/',
                ...
                <a href="https://www.figma.com/design/5eUk7EYGAjTFCIOSVpJxgS/Preview-%7C%C2%A0Ultima-%7C%C2%A03.0.0?node-id=0-1&t=WtPNbQrpbf9V2eTz-1">preview the Figma file</a> before the purchase. Note that PhaseVue UI components are excluded from the Ultima
                Figma file as they are available in <PhaseVueNuxtLink to="/uikit">PrimeOne for Figma</PhaseVueNuxtLink> only.`
                        }
                    },
                    {
