    ...
    data() {
        return {
            avalonData: {
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                rectangle: false,
                                dashboard1: '/images/templates/avalon/nextgen/avalon-hero-dashboard1.jpg',
                                dashboard2: '/images/templates/avalon/nextgen/avalon-hero-dashboard2.jpg',
                                description: 'A sleek, user-friendly premium app template featuring a highly customizable layout. Built with Tailwind CSS, it`s fully responsive, touch-optimized, and developed with PhaseVue.',
                                liveHref: 'https://avalon.phasevue.org/',
                                docHref: 'https://avalon.phasevue.org/documentation',
                                ...
                                pattern: {
                                    ...
                                    src: '/images/templates/avalon/avalon-hero-pattern.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://avalon.phasevue.org/documentation',
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: '/images/templates/avalon/nextgen/features-animation-darkmode.jpg'
                                },
                                {
                                    id: 2,
                                    ...
                                    src: '/images/templates/avalon/nextgen/features-animation-component-themes.jpg'
                                },
                                {
                                    id: 3,
                                    ...
                                    inlineFeaturesData: [
                                        {
                                            id: 1,
                                            title: 'Static',
                                            src: '/images/templates/avalon/nextgen/static.png'
                                        },
                                        {
                                            id: 2,
                                            title: 'Slim',
                                            src: '/images/templates/avalon/nextgen/slim.png'
                                        },
                                        {
                                            id: 3,
                                            title: 'Reveal',
                                            src: '/images/templates/avalon/nextgen/reveal.png'
                                        },
                                        {
                                            id: 4,
                                            title: 'Horizontal',
                                            src: '/images/templates/avalon/nextgen/horizontal.png'
                                        },
                                        {
                                            id: 5,
                                            title: 'Overlay',
                                            src: '/images/templates/avalon/nextgen/overlay.png'
                                        },
                                        {
                                            id: 6,
                                            title: 'Compact',
                                            src: '/images/templates/avalon/nextgen/compact.png'
                                        },
                                        {
                                            id: 7,
                                            title: 'Drawer',
                                            src: '/images/templates/avalon/nextgen/drawer.png'
                                        }
                                    ]
                                }
                            ]
                    ...
                    },
                    {
                        ...
                        props: {
                            featuresData: [
                                {
                                    src: '/images/templates/avalon/nextgen/avalon-features1-feature1.png',
                                ...
                                {
                                    src: '/images/templates/avalon/nextgen/avalon-features1-feature2.png',
                                ...
                                {
                                    src: '/images/templates/avalon/nextgen/avalon-features1-feature3.png',
                        ...
                        props: {
                            featuresData: [
                                ...
                                },
                                {
                                    ...
                                    src: '/images/templates/avalon/nextgen/features-animation-figma.png'
                                }
                            ]
                        },
                        slots: {
                ...
                <a href="https://www.figma.com/design/kOSpIMmOxQ3vWq7md9ZIqZ/Preview-%7C-Avalon-%7C-2.0.0?node-id=6184-14861&t=2WN09Iqp8HcYlKkE-1" target="_blank" rel="noopener noreferrer">preview the Figma file</a> before the purchase. Note that PhaseVue UI components are excluded from the
                Avalon Figma file as they are available in <PhaseVueNuxtLink to="/uikit">PrimeOne for Figma</PhaseVueNuxtLink> only.`
                        }
                    },
                    {
                        name: markRaw(TemplateFeatures),
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: '/images/templates/avalon/nextgen/avalon-features2-responsive.jpg'
                                },
                                {
                                ...
                                },
                                {
                                    ...
                                    src: '/images/templates/avalon/nextgen/avalon-features2-mobile.jpg'
                                }
                            ],
