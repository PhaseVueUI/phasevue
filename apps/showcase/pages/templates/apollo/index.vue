                ...
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                liveHref: 'https://apollo.phasevue.org',
                                docHref: 'https://apollo.phasevue.org/documentation',
                                ...
                                pattern: {
                                    ...
                                    src: '/images/templates/apollo/apollo-hero-pattern.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://apollo.phasevue.org/documentation/',
                    ...
                    before the purchase. Note that PhaseVue UI components are excluded from the Apollo Figma file as they are available in
                    <PhaseVueNuxtLink to="/uikit">PrimeOne for Figma</PhaseVueNuxtLink> only.`
                        }
                    },
                    {
                        name: markRaw(TemplateFeatures),
