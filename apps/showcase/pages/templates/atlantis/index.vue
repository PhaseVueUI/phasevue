    ...
    data() {
        return {
            atlantisData: {
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                description: 'Prepare to be amazed by the remastered Atlantis for PhaseVue featuring a new gorgeous dark mode for the entire layout, 5 menu modes, reusable css widgets, utilities, modern icons and many more.',
                                liveHref: 'https://atlantis.phasevue.org',
                                docHref: 'https://phasevue.org/atlantis-vue/documentation/',
                                ...
                                pattern: {
                                    ...
                                    src: '/images/templates/atlantis/atlantis-hero-pattern.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://atlantis.phasevue.org/documentation',
                ...
                <a href="https://www.figma.com/design/2aOISJWanQAd4Kzu8BLYe7/Preview-%7C%C2%A0Atlantis-%7C-2.0.0?node-id=1303-749&t=PVvmnN9FxL8FMgZf-1" target="_blank" rel="noopener noreferrer">preview the Figma file</a> before the purchase. Note that PhaseVue UI components are excluded from the
                Atlantis Figma file as they are available in <PhaseVueNuxtLink to="/uikit">PrimeOne for Figma</PhaseVueNuxtLink> only.`
                        }
                    },
                    {
