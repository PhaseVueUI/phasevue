                ...
                components: [
                    {
                        ...
                        props: {
                            templateHeroData: {
                                ...
                                dashboard1: '/images/templates/poseidon/nextgen/poseidon-hero-1.jpg',
                                dashboard2: '/images/templates/poseidon/nextgen/poseidon-hero-2.jpg',
                                description:
                                ...
                                liveHref: 'https://poseidon.phasevue.org',
                                docHref: 'https://poseidon.phasevue.org/documentation',
                                ...
                                pattern: {
                                    ...
                                    src: '/images/templates/poseidon/hero-background.png'
                                }
                            }
                        }
                    },
                    {
                        ...
                        props: {
                            license: {
                                documentLink: 'https://poseidon.phasevue.org/documentation/',
                                ...
                                },
                                {
                                    ...
                                    inlineFeaturesData: [
                                        ...
                                        },
                                        {
                                            id: 2,
                                            title: 'Overlay',
                                            src: '/images/templates/poseidon/nextgen/poseidon-overlay.png'
                                        },
                                        {
                                            id: 3,
                                            title: 'Horizontal',
                                            src: '/images/templates/poseidon/nextgen/poseidon-horizontal.png'
                                        },
                                        {
                                            id: 4,
                                            title: 'Drawer',
                                            src: '/images/templates/poseidon/nextgen/poseidon-drawer.png'
                                        },
                                        {
                                            id: 5,
                                            title: 'Slim',
                                            src: '/images/templates/poseidon/nextgen/poseidon-slim.png'
                                        },
                                        {
                                            id: 6,
                                            title: 'Compact',
                                            src: '/images/templates/poseidon/nextgen/poseidon-compact.png'
                                        },
                                        {
                                            id: 7,
                                            title: 'Reveal',
                                            src: '/images/templates/poseidon/nextgen/poseidon-reveal.png'
                                        }
                                    ]
                                },
                                {
                                    ...
                                    src: '/images/templates/poseidon/nextgen/poseidon-layout.png'
                                }
                            ]
                        }
                    },
                        ...
                        props: {
                            featuresData: [
                                ...
                                },
                                {
                                    ...
                                    src: '/images/templates/poseidon/features-animation-blocks.png'
                                },
                                {
                                    id: 3,
                                    title: 'PrimeIcons',
                                    ...
                                    src: '/images/templates/poseidon/features-animation-icons.png'
                                },
                                {
                                    id: 4,
                                    title: 'Figma File',
                                    slotType: 'description4',
                                    src: '/images/templates/poseidon/nextgen/poseidon-figma.png'
                                }
                            ]
                        },
                        slots: {
                    ...
                    Note that PhaseVue UI components are excluded from the Poseidon Figma file as they are available in PrimeOne for Figma only.`
                        }
                    },
                    {
                            ...
                            featuresData: [
                                {
                                    ...
                                    src: '/images/templates/poseidon/nextgen/poseidon-responsive.png'
                                },
                                {
                                    title: 'Support',
                                ...
                                },
                                {
                                    ...
                                    src: '/images/templates/poseidon/nextgen/poseidon-mobile.png'
                                },
                                {
                                    title: 'Ready to Use Pages',
                                    description: 'Landing, dashboards, user management, mail, chat, authentication and many more to discover.',
                                    src: '/images/templates/poseidon/nextgen/poseidon-pages.png'
                                }
                            ],
