<template>
    <Head>
        <Title>Tailwind CSS - PhaseVue</Title>
        <Meta name="description" content="Integration between PhaseVue and Tailwind CSS both in styled and unstyled modes" />
    </Head>
    <div class="doc">
        <div class="doc-main">
            <div class="doc-intro">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                    <div class="flex-1">
                        <h1>Tailwind CSS</h1>
                        <p>Integration between PhaseVue and Tailwind CSS both in styled and unstyled modes.</p>
                    </div>
        ...
        return {
            docs: [
                ...
                },
                {
                    id: 'samples',
                    label: 'Samples',
                    description: 'Example uses cases with PhaseVue and Tailwind CSS.',
                    children: [
                        {
                            id: 'colorpalette',
                            label: 'Color Palette',
