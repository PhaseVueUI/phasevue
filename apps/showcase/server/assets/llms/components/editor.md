...
```javascript
import Editor from 'phasevue/editor';
```
...
Editor integrates seamlessly with the PhaseVue Forms library.
...
const value = ref('<div>Hello World!</div><div>PhaseVue <b>Editor</b> Rocks</div><div><br></div>');
<\/script>
```
