<template>
    <DocSectionText>
        <p>PhaseVue offers various preset options that allow you to customize the component's styling to match your application's design system. Below you'll find links to the implementation and type definitions for each preset.</p>
                ...
                <tbody>
                    <tr v-for="preset in presets" :key="preset">
                        ...
                        <td :class="`doc-option-preset-implementation-${preset.toLowerCase()}`">
                            <a
                                :href="`https://github.com/PhaseVueUI/primeuix/blob/main/packages/themes/src/presets/${preset.toLowerCase()}/${$attrs.data}/index.ts`"
                                target="_blank"
                        ...
                        <td :class="`doc-option-preset-type-${preset.toLowerCase()}`">
                            <a
                                :href="`https://github.com/PhaseVueUI/primeuix/blob/main/packages/themes/src/presets/${preset.toLowerCase()}/${$attrs.data}/index.d.ts`"
                                target="_blank"
                                rel="noopener noreferrer"
                                class="inline-flex rounded-full px-3 py-1 bg-surface-200 hover:bg-surface-300 transition-all duration-200 gap-2 items-center text-sm dark:bg-surface-800 dark:hover:bg-surface-700"
                            >
