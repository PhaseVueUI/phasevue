<template>
    <DocSectionText v-bind="$attrs">
        <p>FloatLabel visually integrates a label with its form element. Visit <PhaseVueNuxtLink to="/floatlabel">FloatLabel</PhaseVueNuxtLink> documentation for more information.</p>
    </DocSectionText>
