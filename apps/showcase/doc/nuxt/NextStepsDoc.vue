<template>
    <DocSectionText v-bind="$attrs">
        <p>Welcome to the Prime UI Ecosystem! Once you have PhaseVue up and running, we recommend exploring the following resources to gain a deeper understanding of the library.</p>
