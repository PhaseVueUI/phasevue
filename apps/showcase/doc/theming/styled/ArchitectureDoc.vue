<template>
    <DocSectionText v-bind="$attrs">
        <p>
            PhaseVue is a design agnostic library so unlike some other UI libraries it does not enforce a certain styling such as material design. Styling is decoupled from the components using the themes instead. A theme consists of two parts;
        ...
        <img alt="Architecture" src="/images/phasevue-v4-styled-architecture.png" class="w-full mb-4" />
        ...
        <p>
            ...
            component. By defining your own design tokens as a custom preset, you'll be able to define your own style without touching CSS. Overriding the PhaseVue components using style classes is not a best practice and should be the last resort,
            design tokens are the suggested approach.
        </p>

        <h3>Video Tutorial</h3>
        <p>Watch the <b>PhaseVue Theming Demystified</b> series to learn more about the architecture with examples.</p>
