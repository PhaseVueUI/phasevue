<template>
    <DocSectionText v-bind="$attrs">
        <p>IftaLabel is used to create infield top aligned labels. Visit <PhaseVueNuxtLink to="/iftalabel">IftaLabel</PhaseVueNuxtLink> documentation for more information.</p>
    </DocSectionText>
