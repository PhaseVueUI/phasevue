<template>
    <DocSectionText label="Non-PhaseVue" :level="2" v-bind="$attrs">
        <p>Form API is not strictly tied to PhaseVue components, providing a flexible way to manage validation and state for any native HTML elements, your own custom components or third-party libraries.</p>
    </DocSectionText>
