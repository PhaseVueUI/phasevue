<template>
    <DocSectionText v-bind="$attrs">
        <p>
            Section names prefixed with <i>pc</i> denote PhaseVue components, distinguishing them from standard DOM elements and indicating the necessity for a nested structure. For example, the "badge" section is identified as <i>pcBadge</i> because
