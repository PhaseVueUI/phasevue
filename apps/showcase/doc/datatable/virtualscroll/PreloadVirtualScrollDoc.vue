<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <PhaseVueNuxtLink to="/virtualscroller">VirtualScroller</PhaseVueNuxtLink> component is utilized so refer to the API of VirtualScroller for more information about the available options.
        </p>
