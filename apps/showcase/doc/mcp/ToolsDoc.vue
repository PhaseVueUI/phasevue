<template>
    <DocSectionText v-bind="$attrs">
        ...
        <p>Tools for exploring and understanding PhaseVue components.</p>
        <ul class="leading-loose list-disc ml-6">
            <li><i>list_components</i> : List all PhaseVue components with categories</li>
        ...
        <p>Tools for accessing PhaseVue documentation and guides.</p>
        <ul class="leading-loose list-disc ml-6">
            <li><i>list_guides</i> : List all guides and documentation pages</li>
            <li><i>get_guide</i> : Get a specific guide by name</li>
            <li><i>get_configuration</i> : Get PhaseVue configuration options</li>
