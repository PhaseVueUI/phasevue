<template>
    <DocSectionText v-bind="$attrs">
        <p>A floating label appears on top of the input field when focused. Visit <PhaseVueNuxtLink to="/floatlabel">FloatLabel</PhaseVueNuxtLink> documentation for more information.</p>
    </DocSectionText>
