<template>
    <DocSectionText v-bind="$attrs">
        <p>Animation classes are defined with the <i>enterClass</i> and <i>leaveClass</i> properties. This example utilizes <i>tailwind-phasevue</i> plugin animations however any valid CSS animation is supported.</p>
    </DocSectionText>
